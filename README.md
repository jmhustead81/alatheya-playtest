...
Choose **Join a game**, enter the host's public IPv4 address or hostname, and keep the port at **9999**. The host
and every player must use the same release. Hosting over the internet requires inbound UDP 9999 in Windows
